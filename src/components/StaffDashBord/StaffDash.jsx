      ...
      <div className="container-fluid">
        ...
        <div className="row">
          <div className="row g-3">
            ...
            <div className="col col-12 col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-3">
              <AdminCards heading="View Students" link="/viewStudentStaff" />
            </div>
            <div className="col col-12 col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-3">
              <AdminCards heading="Add Attandance" link="/addAttandance" />
            </div>
            <div className="col col-12 col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-3">
              <AdminCards heading="View Attandance" link="/viewAttandance" />
            </div>
          </div>
        </div>
      </div>
